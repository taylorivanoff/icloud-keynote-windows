...
iCloud Keynote desktop app for Windows. Loads [icloud.com/keynote](https://www.icloud.com/keynote) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `icloud-keynote://` protocol handler
